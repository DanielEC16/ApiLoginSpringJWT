...
import com.spring.security.config.filter.JwtTokenValidator;
...
public class SecurityConfig {
    ...
    @Bean
    public AuthenticationProvider authenticationProvider(UserDetailServicesImpl userDetailService){
